    ...
    <section className="relative bg-whiteSoft text-blackDeep z-50 py-28 px-6 overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-600 uppercase tracking-[0.25em] mb-20">
          Ce n’est pas de la magie. C’est une méthodologie{" "}
          <span className="text-goldSoft font-medium">éprouvée</span>.
        </p>
      </motion.div>
      ...
      <div className="relative z-10 grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {methods.map((m, i) => (
          ...
          >
            ...
            <motion.div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 group-hover:w-3/4 h-[2px] bg-gradient-to-r from-goldSoft/80 to-transparent rounded-full transition-all duration-500" />
          </motion.div>
        ))}
      </div>
      ...
      >
        <p>
          Une approche{" "}
          <span className="text-goldSoft font-medium">efficace</span>,{" "}
