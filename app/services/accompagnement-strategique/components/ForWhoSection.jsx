    ...
    <section className="relative bg-whiteSoft text-blackDeep py-16 px-6 overflow-hidden">
      ...
      >
        ...
        <ul className="space-y-4">
          {[
            "Accélérer leur croissance et acquérir plus d'utilisateurs",
            "Optimiser leur stratégie marketing et leur funnel de conversion",
            "Trouver le Product-Market Fit et affiner leur positionnement",
            "Structurer leur roadmap produit pour maximiser l'impact",
          ].map((item, i) => (
            <motion.li
              key={i}
