  ...
  return (
    <section className="relative w-full text-center py-32 bg-blackDeep overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-8">
        ...
        >
          Nous aidons les SaaS existants à intégrer l'intelligence artificielle
          et l'automatisation pour créer un avantage compétitif immédiat et
          transformer l'expérience de leurs utilisateurs.
        </motion.p>
      </div>
    </section>
  );
