  ...
  return (
    <section className="relative w-full text-center py-32 bg-blackDeep overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-8">
        ...
        >
          Découvrez les projets sur lesquels nous avons travaillé et comment
          nous avons aidé nos clients à transformer leurs visions en produits
          réels et fonctionnels.
        </motion.p>
      </div>
    </section>
  );
